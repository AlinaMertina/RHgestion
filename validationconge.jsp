                      ...
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered">
                            ...
                            <form action="/RHgestion/insertvalidationsh1.do" method="post">
                              <tbody>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                      <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" name="idconger[]" value="<%= (String) value.get("idconger") %>" id="membershipRadios1"  checked>
