              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste cnaps</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                            <a href="http://localhost:8080/RHgestion/paginationcnaps.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <a href="http://localhost:8080/RHgestion/sudo.do" > <button type="button" class="btn btn-outline-secondary" href="#" >X</button> </a>
                            <a  href="http://localhost:8080/RHgestion/paginationcnaps.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Cnaps service =  (Cnaps) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidcnaps() ); %> </td>
                                      <td class="py-1"><% out.println( service.getdescription() ); %> </td>
                                      <td class="py-1"><% out.println( service.getpourcentage() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletecnaps.do?idcnaps=<% out.println( service.getidcnaps() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Cnaps</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcnaps">
                          <label for="exampleInputUsername1">description</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="description">
                          <label for="exampleInputUsername1">pourcentage</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="pourcentage">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcnaps" value="<% out.print( service.getidcnaps() ); %>" >
                          <label for="exampleInputUsername1">description</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="description" value="<% out.print( service.getdescription() ); %>" >
                          <label for="exampleInputUsername1">pourcentage</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="pourcentage" value="<% out.print( service.getpourcentage() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertcnaps.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationcnaps.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
