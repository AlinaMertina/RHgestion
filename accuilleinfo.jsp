        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Hierarchie</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost:8080/RHgestion/accuillehierarchie.do">Ajout</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              ...
              <span class="menu-title">Demande Besoin</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="http://localhost:8080/RHgestion/accuilledemande_besoin.do">Ajout</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost:8080/RHgestion/accuillecritere.do">Critere</a></li>
                <li class="nav-item"> <a class="nav-link" href="http://localhost:8080/RHgestion/accuilledetaille_critere.do">Detaille critere</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Note details critere</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
