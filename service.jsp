              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste service</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationservice.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                           <a href="/RHgestion/sudo.do" > <button type="button" class="btn btn-outline-secondary" href="#" >X</button>  </a>
                          <a  href="http://localhost:8080/RHgestion/paginationservice.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Service service =  (Service) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidservice() ); %> </td>
                                      <td class="py-1"><% out.println( service.getnomservice() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deleteservice.do?idservice=<% out.println( service.getidservice() ); %>">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      ...
                      <label for="exampleInputUsername1">nomservice</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nomservice">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <label for="exampleInputUsername1">idservice</label>
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idservice" value="<% out.print( service.getidservice() ); %>" >
                      <label for="exampleInputUsername1">nomservice</label>
                          <label for="exampleInputUsername1">nomservice</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nomservice" value="<% out.print( service.getnomservice() ); %>" >
                        </div>
