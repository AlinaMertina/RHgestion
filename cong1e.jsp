              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste conge</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationconge.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <button type="button" class="btn btn-outline-secondary" href="#" >X</button>
                            <a  href="http://localhost:8080/RHgestion/paginationconge.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Conge service =  (Conge) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidconger() ); %> </td>
                                      ...
                                      <td class="py-1"><% out.println( service.getraison() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deleteconge.do?idconger=<% out.println( service.getidconger() ); %>">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idconger">
                      ...
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="raison">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idconger" value="<% out.print( service.getidconger() ); %>" >
                          <label for="exampleInputUsername1">idfcandidat</label>
                      ...
                      <input type="date" class="form-control" id="exampleInputUsername1"  name="datefin" value="<% out.print( service.getdatefin() ); %>" >
                          <label for="exampleInputUsername1">raison</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="raison" value="<% out.print( service.getraison() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertconge.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationconge.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
