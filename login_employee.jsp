...
<%@page import="etu002087.superutilisateur.Login_employee"%>
<%
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste login_employee</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationlogin_employee.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <button type="button" class="btn btn-outline-secondary" href="#" >X</button>
                            <a  href="http://localhost:8080/RHgestion/paginationlogin_employee.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Login_employee service =  (Login_employee) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidfemployee() ); %> </td>
                                      <td class="py-1"><% out.println( service.getmodpass() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletelogin_employee.do?idfemployee=<% out.println( service.getidfemployee() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Login_employee</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <label for="exampleInputUsername1">idfemployee</label>
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idfemployee">
                      <label for="exampleInputUsername1">modpass</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="modpass">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <label for="exampleInputUsername1">idfemployee</label>
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idfemployee" value="<% out.print( service.getidfemployee() ); %>" >
                      <label for="exampleInputUsername1">modpass</label>
                          <label for="exampleInputUsername1">modpass</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="modpass" value="<% out.print( service.getmodpass() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertlogin_employee.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationlogin_employee.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
