...
<%@page import="etu002087.payement.Irsa"%>
<%
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste irsa</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationirsa.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                           <a href="http://localhost:8080/RHgestion/sudo.do" ><button type="button" class="btn btn-outline-secondary" href="#" >X</button> </a>
                            <a  href="http://localhost:8080/RHgestion/paginationirsa.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Irsa service =  (Irsa) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidirsa() ); %> </td>
                                      <td class="py-1"><% out.println( service.getinf() ); %> </td>
                                      <td class="py-1"><% out.println( service.getsup() ); %> </td>
                                      <td class="py-1"><% out.println( service.gettaux() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deleteirsa.do?idirsa=<% out.println( service.getidirsa() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Irsa</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idirsa">
                          <label for="exampleInputUsername1">inf</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="inf">
                      ...
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="taux">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idirsa" value="<% out.print( service.getidirsa() ); %>" >
                          <label for="exampleInputUsername1">inf</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="inf" value="<% out.print( service.getinf() ); %>" >
                          <label for="exampleInputUsername1">sup</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="sup" value="<% out.print( service.getsup() ); %>" >
                          <label for="exampleInputUsername1">taux</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="taux" value="<% out.print( service.gettaux() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertirsa.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationirsa.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
