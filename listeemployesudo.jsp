              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste employee    <b style="color: white;">XXXXXXX</b>   
                              ...
                              <tbody>
                                <% for(int i=0;i<liste.size();i++) { HashMap<String,Object>  value = (HashMap<String,Object>)  liste.get(i); %>
                                    <tr>
                                        ...
                                        <td><%= (String) value.get("nom") %></td>
                                        <td><%= (String) value.get("prenom") %></td>
                                        <td><%= (String) value.get("nomhierarchie")  %></td>
                                        <td><%=  (Integer) value.get("age") %></td>
                                        <td><%=  (Integer) value.get("ancienete") %></td>
                                    </tr>
                                <% } %>  
