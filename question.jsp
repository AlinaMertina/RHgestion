...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste question</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationquestion.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                           <a href="/RHgestion/accuilledemande_besoin.do"><button type="button" class="btn btn-outline-secondary" href="#" >X</button></a>
                           
                            <a  href="http://localhost:8080/RHgestion/paginationquestion.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
 ...
 <th>note</th>
                  ...
                  <% for(int i=0; i<liste.size();i++) { Question service =  (Question) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidquestion() ); %> </td>
                                      <td class="py-1"><% out.println( service.getidfdemande() ); %> </td>
                                      <td class="py-1"><% out.println( service.gettextquestion() ); %> </td>
                                      ...
                                      <td>
                                      <a href="http://localhost:8080/RHgestion/deletequestion.do?idquestion=<% out.println( service.getidquestion() ); %>">
                                      ...
                                      <td>
                                        <a href="http://localhost:8080/RHgestion/accuillechoixquestion.do?idfquestion=<% out.println( service.getidquestion() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Question</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idquestion">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idfdemande">
                          <label for="exampleInputUsername1">textquestion</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="textquestion" width="100%">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idquestion" value="<% out.print( service.getidquestion() ); %>" >
                      ...
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idfdemande" value="<% out.print( service.getidfdemande() ); %>" >
                          <label for="exampleInputUsername1">textquestion</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="textquestion" value="<% out.print( service.gettextquestion() ); %>" >
                          <label for="exampleInputUsername1">note</label>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertquestion.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationquestion.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
