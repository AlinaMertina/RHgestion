          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">Desolle mais cette employee ne peux pas prendre une congee car il na pas encore complete sont 1 ans de travaille demander mais si vous inciste le conge sera non remuneree</h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">

                <a class="text-white font-weight-medium" href="listeemployerconger.do">retour</a>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton3">
                    ...
                    <% for(int a=0 ; a<conge.size() ;a++) {  Congespecifie con = (Congespecifie) conge.get(a); %>
                      <a class="dropdown-item" href="<%= con.getidcongespecifie() %>"><%= con.getnomconge() %></a>
                    <% } %>
                  </div>
                </div>
