...
<%@page import="etu002087.demandebesoin.Reponsequetion"%>
<%
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste reponsequetion</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationreponsequetion.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <button type="button" class="btn btn-outline-secondary" href="#" >X</button>
                            <a  href="http://localhost:8080/RHgestion/paginationreponsequetion.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
                        <div class="table-responsive">
                          <table class="table table-striped">
                            ...
                            <thead>
                              <tr>
 <th>idreponse</th>
 <th>idfchoixquestion</th>
 <th>idfcandidat</th>
                                    </tr>
<% for(int i=0; i<liste.size();i++) { Reponsequetion service =  (Reponsequetion) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidreponse() ); %> </td>
                                      <td class="py-1"><% out.println( service.getidfchoixquestion() ); %> </td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletereponsequetion.do?idreponse=<% out.println( service.getidreponse() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Reponsequetion</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idreponse">
                          <label for="exampleInputUsername1">idfchoixquestion</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idfchoixquestion">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idreponse" value="<% out.print( service.getidreponse() ); %>" >
                          <label for="exampleInputUsername1">idfchoixquestion</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idfchoixquestion" value="<% out.print( service.getidfchoixquestion() ); %>" >
                          <label for="exampleInputUsername1">idfcandidat</label>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertreponsequetion.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationreponsequetion.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
