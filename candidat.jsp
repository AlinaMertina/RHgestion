...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste candidat</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationcandidat.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <button type="button" class="btn btn-outline-secondary" href="#" >X</button>
                            <a  href="http://localhost:8080/RHgestion/paginationcandidat.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
 ...
 <th>nom</th>
 <th>prenom</th>
 <th>datedenaisance</th>
 <th>mail</th>
 <th>tel</th>
 <th>depotdecandidature</th>
 <th>idfsexe</th>
                                    </tr>
<% for(int i=0; i<liste.size();i++) { Candidat service =  (Candidat) liste.get(i); %>
                                    <tr>
                                      ...
                                      <td class="py-1"><% out.println( service.getdatedenaisance() ); %> </td>
                                      <td class="py-1"><% out.println( service.getmail() ); %> </td>
                                      <td class="py-1"><% out.println( service.gettel() ); %> </td>
                                      <td class="py-1"><% out.println( service.getdepotdecandidature() ); %> </td>
                                      <td class="py-1"><% out.println( service.getidfsexe() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletecandidat.do?idcandidat=<% out.println( service.getidcandidat() ); %>">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcandidat">
                          <label for="exampleInputUsername1">nom</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nom">
                          <label for="exampleInputUsername1">prenom</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="prenom">
                          <label for="exampleInputUsername1">datedenaisance</label>
                      <input type="date" class="form-control" id="exampleInputUsername1"  name="datedenaisance">
                          <label for="exampleInputUsername1">mail</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="mail">
                          <label for="exampleInputUsername1">tel</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="tel">
                          <label for="exampleInputUsername1">depotdecandidature</label>
                      <input type="date" class="form-control" id="exampleInputUsername1"  name="depotdecandidature">
                          <label for="exampleInputUsername1">idfsexe</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idfsexe">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcandidat" value="<% out.print( service.getidcandidat() ); %>" >
                          <label for="exampleInputUsername1">nom</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nom" value="<% out.print( service.getnom() ); %>" >
                          <label for="exampleInputUsername1">prenom</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="prenom" value="<% out.print( service.getprenom() ); %>" >
                          <label for="exampleInputUsername1">datedenaisance</label>
                      <input type="date" class="form-control" id="exampleInputUsername1"  name="datedenaisance" value="<% out.print( service.getdatedenaisance() ); %>" >
                          <label for="exampleInputUsername1">mail</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="mail" value="<% out.print( service.getmail() ); %>" >
                          <label for="exampleInputUsername1">tel</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="tel" value="<% out.print( service.gettel() ); %>" >
                          <label for="exampleInputUsername1">depotdecandidature</label>
                      <input type="date" class="form-control" id="exampleInputUsername1"  name="depotdecandidature" value="<% out.print( service.getdepotdecandidature() ); %>" >
                          <label for="exampleInputUsername1">idfsexe</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idfsexe" value="<% out.print( service.getidfsexe() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertcandidat.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationcandidat.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
