...
<%@page import="etu002087.conge.Listeconge"%>
<%
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste listeconge</h2>
                        ...
                        <div class="content-wrapper"  class="pagination">
                          <div class="btn-group" role="group" aria-label="Basic example" class="pagination2"></div>
                           <a href="http://localhost:8080/RHgestion/paginationlisteconge.do?nbr=<%  out.println(precedent); %>" >  <button type="button" class="btn btn-outline-secondary"  >1</button> </a>
                            <button type="button" class="btn btn-outline-secondary" href="#" >X</button>
                            <a  href="http://localhost:8080/RHgestion/paginationlisteconge.do?nbr=<%  out.println(suivant); %>"> <button type="button" class="btn btn-outline-secondary">3</button> </a>
                          </div>
...
<% for(int i=0; i<liste.size();i++) { Listeconge service =  (Listeconge) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidlisteconge() ); %> </td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletelisteconge.do?idlisteconge=<% out.println( service.getidlisteconge() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Listeconge</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idlisteconge">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idlisteconge" value="<% out.print( service.getidlisteconge() ); %>" >
                          <label for="exampleInputUsername1">nomconge</label>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertlisteconge.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationlisteconge.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
