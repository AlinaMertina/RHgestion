...
<%  for(int i=0; i<liste.size();i++) { Candidat candidat = (Candidat) liste.get(i);  %>
    ...
    <!-- partial -->
    <div class="container-fluid page-body-wrapper critere" style="width:50%;margin: auto;background-color: none;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <% } %>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td> <a href="#"> <button  class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" onclick="subcandidat(event,<%= i+1 %>)">Next Candidat</button>  </a> </td>
                                </tr>
                            </tbody>
                        </table>
                        </div>
