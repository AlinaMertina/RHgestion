            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-8 grid-margin stretch-card" style="margin: auto;">
                        <div class="card">
                          <div class="card-body">
                            <h4 class="card-title">Demande heur sup
                                <b style="color: white;">XXXXXXX</b>
                                        <a href="http://localhost:8080/RHgestion/pageinsertheursup.do">
                            ...
                            <form class="forms-sample" action="http://localhost:8080/RHgestion/insertheursup.do" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="yyyy-mm-dd hh:mm:ss" name="debut">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword4">Fin</label>
                                <input type="text" class="form-control" id="exampleInputPassword4" placeholder="yyyy-mm-dd hh:mm:ss" name="fin">
                            </div>
