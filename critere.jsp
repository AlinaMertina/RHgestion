              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title">Liste critere</h2>
...
<% for(int i=0; i<liste.size();i++) { Critere service =  (Critere) liste.get(i); %>
                                    <tr>
                                      <td class="py-1"><% out.println( service.getidcritere() ); %> </td>
                                      <td class="py-1"><% out.println( service.getnomcritere() ); %> </td>
                                      <td class="py-1"><% out.println( service.getidservice() ); %> </td>
                                      <td class="py-1"><% out.println( service.getmultipleoupas() ); %> </td>
<td>
...
<td>
<a href="http://localhost:8080/RHgestion/deletecritere.do?idcritere=<% out.println( service.getidcritere() ); %>">
        ...
        <div id="addService">
          <div class="content-popup">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter Critere</h4>
                  <form class="forms-sample" id="creation">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcritere">
                          <label for="exampleInputUsername1">nomcritere</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nomcritere">
                          
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idservice">
                          <label for="exampleInputUsername1">multipleoupas</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="multipleoupas">
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample formulaiupdate">
                        <div class="form-group">
                      <input type="hidden" class="form-control" id="exampleInputUsername1"  name="idcritere" value="<% out.print( service.getidcritere() ); %>" >
                          <label for="exampleInputUsername1">nomcritere</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="nomcritere" value="<% out.print( service.getnomcritere() ); %>" >
                          <label for="exampleInputUsername1">idservice</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="idservice" value="<% out.print( service.getidservice() ); %>" >
                          <label for="exampleInputUsername1">multipleoupas</label>
                      <input type="texte" class="form-control" id="exampleInputUsername1"  name="multipleoupas" value="<% out.print( service.getmultipleoupas() ); %>" >
                        </div>
...
<script type="text/javascript">      function addService() {        document.getElementById('addService').style.display='block';
      ...
      document.getElementById("creation").addEventListener("submit", function(event) {
        ...
        fetch("http://localhost:8080/RHgestion/insertcritere.do", {
            method: "POST", 
    ...
    function updateforme(id){
      ...
      fetch("http://localhost:8080/RHgestion/modificationcritere.do", {
            method: "POST",
            body: formData // Les données du formulaire
        })
        .then(response => response.json()) 
